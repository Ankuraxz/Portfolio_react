      ...
      <div className={styles.intro_outer}>
        <div className={styles.intro_text_content}>
          ...
          <h2 className={styles.short_bio}>
            <strong>" </strong>Frontend Developer Intern at Urmeet | Competitve Programmer | Deep Learning
            Enthusiast<strong> "</strong>
          </h2>
          <p className={styles.inro_lines}>
            I am a hard working, honest individual. I am 
            always willing to learn new skills. I am friendly, helpful and
            polite, have a good sense of humour. I am able to work independently
            in busy environments and also a team setting. I am outgoing and
